  ...
  public CGameF()  {
    ...
    public void actionPerformed(ActionEvent e){
       ...
       if(e.getSource() == btnRedtea){
		  ...
		  lblPlay.setText("紅茶剩餘數量 : "+ drink.getRedteaQuantity());
       }
       // 按布鈕
       if(e.getSource() == btnGreentea){
    	   drink.setGreenteaQuantity(drink.getGreenteaQuantity(), 1);
		  lblPlay.setText("購買一瓶綠茶");
		  lblPlay.setText("綠茶剩餘數量 : "+ drink.getGreenteaQuantity());
       }
       if(e.getSource() == btnCola){
    	   drink.setColaQuantity(drink.getColaQuantity(), 1);
       	  lblPlay.setText("購買一瓶可樂");
       	  lblPlay.setText("可樂剩餘數量 : "+ drink.getColaQuantity());
        }
        // 按石頭鈕
        if(e.getSource() == btnSarsi){
        	drink.setSarsiQuantity(drink.getSarsiQuantity(), 1);
 		  lblPlay.setText("購買一瓶沙士");
 		  lblPlay.setText("咖啡剩餘數量 : "+ drink.getSarsiQuantity());
        }
        // 按布鈕
        if(e.getSource() == btnCoffee){
        	drink.setCoffeeQuantity(drink.getCoffeeQuantity(), 1);
